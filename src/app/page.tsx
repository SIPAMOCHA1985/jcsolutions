      ...
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-[#141512]/80 backdrop-blur-2xl">
        <div className="container flex h-20 items-center justify-between">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <a href="tel:+14075358972" className="inline-flex items-center gap-2 text-sm text-[#d8d0c2] transition hover:text-[#e3c985]">
              <Phone className="h-4 w-4" /> (407) 535-8972
            </a>
        ...
        {menuOpen && (
          <div className="border-t border-white/10 bg-[#141512] px-6 py-6 lg:hidden">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <a href="tel:+14075358972" className="mt-3 text-[#e3c985]">(407) 535-8972</a>
            </nav>
          </div>
        )}
      </header>
          ...
          <div className="container relative z-10 grid min-h-[calc(100vh-7rem)] items-center gap-14 py-16 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="max-w-4xl">
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <a href="https://wa.me/14075358972" className="secondary-button" target="_blank" rel="noreferrer">
        ...
        <section id="contacto" className="relative bg-[#efeadf] py-28 text-[#171814]">
          <div className="container grid gap-14 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <div className="mt-10 grid gap-5">
                <a href="tel:+14075358972" className="contact-line"><Phone className="h-5 w-5" /> (407) 535-8972</a>
            ...
            {status === "sent" ? (
              ...
              <form className="estimate-form" onSubmit={handleSubmit}>
                ...
                <div className="mt-7 flex flex-col gap-4 sm:flex-row">
                  ...
                  <a href="https://wa.me/14075358972" target="_blank" rel="noreferrer" className="secondary-button dark-version">
