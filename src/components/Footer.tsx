...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#060606] border-t border-white/5 px-6 lg:px-12 py-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          {/* Brand */}
          <div>
            <div className="mb-6">
              <p className="font-serif text-xl text-white tracking-[0.15em] uppercase">
                JC Solutions
              </p>
          ...
          {/* Brands */}
          <div>
            <p className="text-[#C9A96E] font-sans text-xs tracking-[0.3em] uppercase mb-6">
              {f.brandsLabel}
            </p>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-white/15 font-sans text-xs">Florida, USA</p>
          </div>
        </div>
      </div>
    </footer>
