...
export default function WhyUs() {
  return (
    <section id="about" className="py-40 px-6 lg:px-12 bg-[#1C1C1C]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24">
          ...
          <p className="text-white/50 font-sans font-light max-w-lg mx-auto leading-relaxed">
            From the first call to the final delivery — we handle every step so you focus on growth.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10">
          {features.map((item) => (
            <div key={item.title}
              className="bg-[#1C1C1C] p-12 lg:p-14 hover:bg-[#252525] transition-colors duration-300 group">
